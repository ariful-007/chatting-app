      ...
      <div className="main_menu">
        ...
        <form onSubmit={handelSubmit}>
          ...
          <div className=" relative">
            ...
            {showIcon ? (
              <IoEye
                onClick={handelShowIcon}
                className=" absolute right-4 cursor-pointer  top-[64%] translate-y-[-50%]"
              />
            ) : (
              <IoEyeOff
                onClick={handelShowIcon}
          ...
          {loader ? (
            ...
            <button type="submit" className="Button_v_1">
              {" "}
              Register{" "}
            </button>
          )}
        ...
        <p className="menu_text">
          ...
          <Link to="/login" className="menu_btn">
            Login
          </Link>
        </p>
      </div>
