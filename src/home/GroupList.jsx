...
const GroupList = () => {
  ...
  return (
    <div id="all-item">
      <div className="main">
        <h2>Group List</h2>
        <button onClick={() => setShow(!show)} className="Button_v_3">
      ...
      {show ? (
        <div className=" p-4 bg-blue-500 rounded-lg">
          <input
            ...
            className=" outline-none p-2 w-full rounded-lg py-1"
          />
          ...
          <input
            ...
            className=" outline-none p-2 w-full rounded-lg py-1 mt-3"
          />
          <p className=" text-red-500">{groupNameError}</p>{" "}
          {/* corrected variable name */}
          <button onClick={handleCreateGroup} className="Button_v_3 w-full">
            Create
          </button>
        </div>
      ) : (
